...
export default function Token() {
  ...
  // get enrichment
  const enrichment = useEnrichmentContract('0x88bDB75E9cfD54438DE55F88c4FF659bb104917e', true)
  const tokenURI = useSingleCallResult(enrichment, 'tokenURI', [enrichTokenId])
  const balance = useSingleCallResult(enrichment, 'balanceOf', ['0x6A23b4c4292975D7E19C1cc1820DDd4954723B61', 1, enrichTokenId])
  const purchased = useSingleCallResult(enrichment, 'purchases', ['0x1e317B4BA581d34c95891b69BD9D9CFF57Df617e'])

  const bal = balance?.result ? balance?.result?.[0] : []
  const uri = tokenURI?.result ? tokenURI?.result?.[0] : ''
  const purchases = purchased?.result ? purchased?.result?.[0] : ''
  ...
  return (
    <>
      ...
      <div className="w-full max-w-2xl p-4 mb-3 rounded">
        ...
        <pre>Enrichment Contract: 0x88bDB75E9cfD54438DE55F88c4FF659bb104917e</pre>
        <pre>
          Owner Balance: {'0x6A23b4c4292975D7E19C1cc1820DDd4954723B61_1'} : {bal}
          <br />
          Enrichment URI: {uri}
          <br />
          Buyer Purchases: {'0x1e317B4BA581d34c95891b69BD9D9CFF57Df617e'} {purchases}
        </pre>
